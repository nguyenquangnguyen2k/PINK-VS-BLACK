...
// include: C:\Users\Admin\AppData\Local\Temp\tmpnr1_75p_.js
  ...
  (() => {
    ...
    loadPackage({"files": [{"filename": "/080884_bullet-hit-39872.mp3", "start": 0, "end": 37920}, {"filename": "/Black.png", "start": 37920, "end": 39375}, {"filename": "/Pinkgun.png", "start": 39375, "end": 42810}, {"filename": "/blood.png", "start": 42810, "end": 44304}, {"filename": "/dan.png", "start": 44304, "end": 44400}, {"filename": "/grunt-1-85280.mp3", "start": 44400, "end": 73200}, {"filename": "/phongnen2.png", "start": 73200, "end": 97899}, {"filename": "/small-monster-attack-195712.mp3", "start": 97899, "end": 122140}], "remote_package_size": 122140});

  })();

// end include: C:\Users\Admin\AppData\Local\Temp\tmpnr1_75p_.js
// include: C:\Users\Admin\AppData\Local\Temp\tmpa_wnguyx.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Admin\AppData\Local\Temp\tmpa_wnguyx.js
// include: C:\Users\Admin\AppData\Local\Temp\tmpjrqo7vru.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Admin\AppData\Local\Temp\tmpjrqo7vru.js
...
var ASM_CONSTS = {
  130544: () => { if (document.fullscreenElement) return 1; },  
 130590: () => { return Module.canvas.width; },  
 130622: () => { return parseInt(Module.canvas.style.width); },  
 130670: () => { document.exitFullscreen(); },  
 130697: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 130770: () => { if (document.fullscreenElement) return 1; },  
 130816: () => { return Module.canvas.width; },  
 130848: () => { return screen.width; },  
 130873: () => { document.exitFullscreen(); },  
 130900: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 131033: () => { return window.innerWidth; },  
 131059: () => { return window.innerHeight; },  
 131086: () => { if (document.fullscreenElement) return 1; },  
 131132: () => { return Module.canvas.width; },  
 131164: () => { return parseInt(Module.canvas.style.width); },  
 131212: () => { if (document.fullscreenElement) return 1; },  
 131258: () => { return Module.canvas.width; },  
 131290: () => { return screen.width; },  
 131315: () => { return window.innerWidth; },  
 131341: () => { return window.innerHeight; },  
 131368: () => { if (document.fullscreenElement) return 1; },  
 131414: () => { return Module.canvas.width; },  
 131446: () => { return screen.width; },  
 131471: () => { document.exitFullscreen(); },  
 131498: () => { if (document.fullscreenElement) return 1; },  
 131544: () => { return Module.canvas.width; },  
 131576: () => { return parseInt(Module.canvas.style.width); },  
 131624: () => { document.exitFullscreen(); },  
 131651: ($0) => { Module.canvas.style.opacity = $0; },  
 131689: () => { return screen.width; },  
 131714: () => { return screen.height; },  
 131740: () => { return window.screenX; },  
 131767: () => { return window.screenY; },  
 131794: () => { return window.devicePixelRatio; },  
 131830: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 131883: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 131934: () => { Module.canvas.style.cursor = 'none'; },  
 131971: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 132227: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 132278: () => { if (document.pointerLockElement) return 1; },  
 132325: () => { if (document.fullscreenElement) return 1; },  
 132371: () => { return window.innerWidth; },  
 132397: () => { return window.innerHeight; },  
 132424: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 134602: () => { if (typeof(window.miniaudio) !== 'undefined') { miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 134892: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 134996: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 135167: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 138044: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 138117: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 138517: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 138567: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 138706: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; }
};
...
function assignWasmExports(wasmExports) {
  ...
  assert(wasmExports['ma_device__on_notification_unlocked'], 'missing Wasm export: ma_device__on_notification_unlocked');
  ...
  assert(wasmExports['ma_malloc_emscripten'], 'missing Wasm export: ma_malloc_emscripten');
  _ma_malloc_emscripten = Module['_ma_malloc_emscripten'] = createExportWrapper('ma_malloc_emscripten', 2);
  assert(wasmExports['ma_free_emscripten'], 'missing Wasm export: ma_free_emscripten');
  _ma_free_emscripten = Module['_ma_free_emscripten'] = createExportWrapper('ma_free_emscripten', 2);
  assert(wasmExports['ma_device_process_pcm_frames_capture__webaudio'], 'missing Wasm export: ma_device_process_pcm_frames_capture__webaudio');
  ...
  assert(wasmExports['ma_device_process_pcm_frames_playback__webaudio'], 'missing Wasm export: ma_device_process_pcm_frames_playback__webaudio');
  ...
  assert(wasmExports['dynCall_ii'], 'missing Wasm export: dynCall_ii');
  dynCall_ii = dynCalls['ii'] = createExportWrapper('dynCall_ii', 2);
  assert(wasmExports['dynCall_vii'], 'missing Wasm export: dynCall_vii');
  dynCall_vii = dynCalls['vii'] = createExportWrapper('dynCall_vii', 3);
  assert(wasmExports['dynCall_viii'], 'missing Wasm export: dynCall_viii');
  dynCall_viii = dynCalls['viii'] = createExportWrapper('dynCall_viii', 4);
  assert(wasmExports['dynCall_viff'], 'missing Wasm export: dynCall_viff');
  dynCall_viff = dynCalls['viff'] = createExportWrapper('dynCall_viff', 4);
  assert(wasmExports['dynCall_viiiii'], 'missing Wasm export: dynCall_viiiii');
  dynCall_viiiii = dynCalls['viiiii'] = createExportWrapper('dynCall_viiiii', 6);
  assert(wasmExports['dynCall_viiii'], 'missing Wasm export: dynCall_viiii');
  dynCall_viiii = dynCalls['viiii'] = createExportWrapper('dynCall_viiii', 5);
  assert(wasmExports['dynCall_vidd'], 'missing Wasm export: dynCall_vidd');
  dynCall_vidd = dynCalls['vidd'] = createExportWrapper('dynCall_vidd', 4);
  assert(wasmExports['dynCall_iiii'], 'missing Wasm export: dynCall_iiii');
  dynCall_iiii = dynCalls['iiii'] = createExportWrapper('dynCall_iiii', 4);
  assert(wasmExports['dynCall_iiiiii'], 'missing Wasm export: dynCall_iiiiii');
  dynCall_iiiiii = dynCalls['iiiiii'] = createExportWrapper('dynCall_iiiiii', 6);
  assert(wasmExports['dynCall_viiiiii'], 'missing Wasm export: dynCall_viiiiii');
  dynCall_viiiiii = dynCalls['viiiiii'] = createExportWrapper('dynCall_viiiiii', 7);
  assert(wasmExports['dynCall_iii'], 'missing Wasm export: dynCall_iii');
  dynCall_iii = dynCalls['iii'] = createExportWrapper('dynCall_iii', 3);
  assert(wasmExports['dynCall_iiiii'], 'missing Wasm export: dynCall_iiiii');
  dynCall_iiiii = dynCalls['iiiii'] = createExportWrapper('dynCall_iiiii', 5);
  assert(wasmExports['dynCall_iiiji'], 'missing Wasm export: dynCall_iiiji');
  dynCall_iiiji = dynCalls['iiiji'] = createExportWrapper('dynCall_iiiji', 5);
  assert(wasmExports['dynCall_iiiiiii'], 'missing Wasm export: dynCall_iiiiiii');
  dynCall_iiiiiii = dynCalls['iiiiiii'] = createExportWrapper('dynCall_iiiiiii', 7);
  assert(wasmExports['dynCall_jii'], 'missing Wasm export: dynCall_jii');
  dynCall_jii = dynCalls['jii'] = createExportWrapper('dynCall_jii', 3);
  assert(wasmExports['dynCall_vi'], 'missing Wasm export: dynCall_vi');
  dynCall_vi = dynCalls['vi'] = createExportWrapper('dynCall_vi', 2);
  assert(wasmExports['dynCall_vffff'], 'missing Wasm export: dynCall_vffff');
  dynCall_vffff = dynCalls['vffff'] = createExportWrapper('dynCall_vffff', 5);
  assert(wasmExports['dynCall_vf'], 'missing Wasm export: dynCall_vf');
  dynCall_vf = dynCalls['vf'] = createExportWrapper('dynCall_vf', 2);
  assert(wasmExports['dynCall_viiiiiiii'], 'missing Wasm export: dynCall_viiiiiiii');
  dynCall_viiiiiiii = dynCalls['viiiiiiii'] = createExportWrapper('dynCall_viiiiiiii', 9);
  assert(wasmExports['dynCall_viiiiiiiii'], 'missing Wasm export: dynCall_viiiiiiiii');
  dynCall_viiiiiiiii = dynCalls['viiiiiiiii'] = createExportWrapper('dynCall_viiiiiiiii', 10);
  assert(wasmExports['dynCall_i'], 'missing Wasm export: dynCall_i');
  dynCall_i = dynCalls['i'] = createExportWrapper('dynCall_i', 1);
  assert(wasmExports['dynCall_vff'], 'missing Wasm export: dynCall_vff');
  dynCall_vff = dynCalls['vff'] = createExportWrapper('dynCall_vff', 3);
  assert(wasmExports['dynCall_v'], 'missing Wasm export: dynCall_v');
  dynCall_v = dynCalls['v'] = createExportWrapper('dynCall_v', 1);
  assert(wasmExports['dynCall_viiiiiii'], 'missing Wasm export: dynCall_viiiiiii');
  dynCall_viiiiiii = dynCalls['viiiiiii'] = createExportWrapper('dynCall_viiiiiii', 8);
  assert(wasmExports['dynCall_vfi'], 'missing Wasm export: dynCall_vfi');
  dynCall_vfi = dynCalls['vfi'] = createExportWrapper('dynCall_vfi', 3);
  assert(wasmExports['dynCall_viif'], 'missing Wasm export: dynCall_viif');
  dynCall_viif = dynCalls['viif'] = createExportWrapper('dynCall_viif', 4);
  assert(wasmExports['dynCall_vif'], 'missing Wasm export: dynCall_vif');
  dynCall_vif = dynCalls['vif'] = createExportWrapper('dynCall_vif', 3);
  assert(wasmExports['dynCall_vifff'], 'missing Wasm export: dynCall_vifff');
  dynCall_vifff = dynCalls['vifff'] = createExportWrapper('dynCall_vifff', 5);
  assert(wasmExports['dynCall_viffff'], 'missing Wasm export: dynCall_viffff');
  dynCall_viffff = dynCalls['viffff'] = createExportWrapper('dynCall_viffff', 6);
  assert(wasmExports['dynCall_vfff'], 'missing Wasm export: dynCall_vfff');
  ...
  assert(wasmExports['dynCall_iidiiii'], 'missing Wasm export: dynCall_iidiiii');
  dynCall_iidiiii = dynCalls['iidiiii'] = createExportWrapper('dynCall_iidiiii', 7);
  assert(wasmExports['asyncify_start_unwind'], 'missing Wasm export: asyncify_start_unwind');
  _asyncify_start_unwind = createExportWrapper('asyncify_start_unwind', 1);
  assert(wasmExports['asyncify_stop_unwind'], 'missing Wasm export: asyncify_stop_unwind');
  _asyncify_stop_unwind = createExportWrapper('asyncify_stop_unwind', 0);
  assert(wasmExports['asyncify_start_rewind'], 'missing Wasm export: asyncify_start_rewind');
  _asyncify_start_rewind = createExportWrapper('asyncify_start_rewind', 1);
  assert(wasmExports['asyncify_stop_rewind'], 'missing Wasm export: asyncify_stop_rewind');
